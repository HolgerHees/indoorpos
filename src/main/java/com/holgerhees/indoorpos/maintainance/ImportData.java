...
public class ImportData
{
    ...
    public static void main( String[] args )
    {
        ...
        try
        {
			...
			createTracker( trackerDAO, livingroomDTO, "livingroom", "Wohnzimmer", "192.168.0.125", -100, -80, 10, 953, 620 );

            // Küche
	        RoomDTO kitchenDTO = createRoom( roomDAO, "Küche", 0 );
	        createArea( areaDAO, kitchenDTO, 274, 640, 509, 420 );
	        createTracker( trackerDAO, kitchenDTO, "kitchen", "Küche", "192.168.0.126", -100, -80, 10, 295, 620 );
	        ...
	        createTracker( trackerDAO, floorDTO, "floor", "Flur", "192.168.0.127", -78, -80, 10, 715, 48 );

	        // Gästezimmer
	        RoomDTO guestroomDTO = createRoom( roomDAO, "Gästezimmer", 0 );
	        createArea( areaDAO, guestroomDTO, 749, 265, 973, 29 );
	        createTracker( trackerDAO, guestroomDTO, "guestroom", "Gästezimmer", "192.168.0.128", -100,-80, 10, 953, 48 );
